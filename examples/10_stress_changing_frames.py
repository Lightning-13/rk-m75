...
def main():
    parser = argparse.ArgumentParser(
        description="Stress-test RK M75 RGB streaming with changing frames."
    )
    ...
    print("RK M75 changing-frame stress test")
    print(f"Duration: {args.duration:g} seconds")
    print("Sending continuously with changing RGB frames...")
    print()
